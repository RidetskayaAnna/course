...
namespace Agent
{
    class datebase
    {
        public string connection = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Diplom\proga\Agent\Agent\HandMS.mdf;Integrated Security=True;Connect Timeout=30";
